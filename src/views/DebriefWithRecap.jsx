...
export default function DebriefWithRecap({step, nxtUrl}) {
                ...
                <Box sx={{ maxWidth: 600, position:"sticky", top: 20, height: 600, overflowY:"auto", textAlign: 'left'}} mx="auto">
                    ...
                    <form onSubmit={form.onSubmit((values) =>{
                        ...
                        { activestage === 4 &&
                            ...
                            <div>
                                <Text> There are charts designed to be <Text span fw={700}>misleading</Text> in the first part of the study.
                                </Text>
                            ...
                            <div>
                                ...
                                <Stack className={classes.questionBlk}>
                                    ...
                                    <Textarea
                                        ...
                                        minRows={3}
                                        autosize
                                        label={<Text>5. Did the effort or attention that you put into answering questions change after noticing the presence of <Text span fw={700}>misleading</Text> charts? If yes, how?</Text>}
